...
<head>
    ...
    <style>
        ...
        .admin-card { background: #fff; padding: 25px; border-radius: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
                ...
                <table>
                    ...
                    while($row = $res->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><a href="?delete_res=<?= $row['id'] ?>" class="btn-del" onclick="return confirm('Удалить ресторан и всё его меню?')">Удалить</a></td>
                        </tr>
                    <?php endwhile; ?>
                </table>
            </div>
            ...
            <div class="admin-card">
                ...
                <form method="POST">
                    ...
                    <select name="res_id" required>
                        ...
                        <?php
                        $res = $conn->query("SELECT id, name FROM restaurants");
